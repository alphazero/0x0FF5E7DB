...
public interface Codec {
	...
	void writeLong(final long v, final byte[] b, final int off) throws NullPointerException, IllegalArgumentException;
	...
	Codec BigEndian = new BigEndian();
	
	// ------------------------------------------------------------------------
	// Ref-Impl 
	// ------------------------------------------------------------------------
	
	public static class BigEndian implements Codec{
		...
		@Override final 
		public void writeLong(final long v, final byte[] b, final int off) throws NullPointerException, IllegalArgumentException {
			if(b==null)
